class AlertSetting < ApplicationRecord
  ...
  validates :temperature_min, numericality: { greater_than_or_equal: 0 }, allow_nil: true
  validates :temperature_max, numericality: { greater_than: :temperature_min }, allow_nil: true
  ...
  def at_least_one_threshold
    fields = [temperature_min, temperature_max, tank_level_min, ground_rh_min, ground_rh_max, luminosity_min, luminosity_max, air_rh_min, air_rh_max]
